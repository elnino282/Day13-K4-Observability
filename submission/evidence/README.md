...
- `langfuse-rag-slow-waterfall.png`: trace `6420376f132f9b69b7a87e59b867e756` (run cuối, khớp `data/logs.jsonl` và REPORT §3/§6) with `rag.retrieve` and `llm.generate` visible.
