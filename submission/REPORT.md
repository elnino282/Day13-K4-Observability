...
| Nguyễn Đình Liên Thành | Phát triển và modularize UI Streamlit; thêm Gemini provider, kiểm thử LLM, xử lý phản hồi Gemini bị cắt; chuẩn bị và thuyết trình demo. | `86e17a8`, `07b3792`, `f91e7e9` | Hiểu cách kết hợp lớp LLM provider với UI vận hành: vẫn dùng fake provider để demo ổn định, nhưng có thể chuyển sang Gemini; đồng thời tổ chức dashboard thành các trang độc lập để demo rõ từng lớp observability. |
